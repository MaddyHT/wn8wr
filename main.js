 ...
 * @type {string}
 */
const SERVER_ADDRESS = 'wss://192.168.81.150:15455';
...
function render() {
    ...
    const winRate1 = victoryCount / (lossCount + victoryCount);
    document.title = renderTitle(wn8);
    document.body.innerHTML = renderContent(wn8, winRate1, showDisconnectedHint, showErrorFetchingExpectedValuesHint);
